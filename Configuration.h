...
#define STRING_CONFIG_H_AUTHOR "bobby" //Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {32,33.007,960*8/3,760*1.1}                    // default steps per unit for ultimaker 
